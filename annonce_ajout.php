...
///////////////////////OK on enregistre tout//////////////////////////////////
    ...
    ////////////////////////////////////////////////
        ...
        $req3 = $pdo->prepare(
            ...
            $req3->bindValue(':prix', getPhoto($pdo, $id_annonce)['photo1'], PDO::PARAM_INT);
            $req3->bindValue(':photo', $_POST['photo1']);
            ...
            $req3->bindValue(':photo_id', getPhoto($pdo, $id_annonce)['id_photo'], PDO::PARAM_INT);
            $req3->bindValue(':categorie_id', getCategorie($pdo, $id_annonce)['id_categorie'], PDO::PARAM_INT);
